    ...
    <section class="py-12 bg-white border-b border-gray-100">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative group">
        ...
        <div 
          ...
          class="flex gap-5 overflow-x-auto snap-x snap-mandatory scroll-smooth py-4 px-1 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]"
        >
          <NuxtLink 
            v-for="cat in displayCategories" 
            :key="cat.id"
            :to="cat.link" 
            class="snap-start shrink-0 w-[220px] group/card cursor-pointer flex flex-col items-center text-center transform transition-transform duration-300 ease-out hover:-translate-y-1.5"
          >
            <div class="aspect-square w-full bg-gray-100 overflow-hidden relative mb-5 rounded-2xl transition-all duration-300 ease-out group-hover/card:shadow-xl border border-transparent group-hover/card:border-gray-100">
